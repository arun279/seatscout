...
map can put you to the seat the mix was balanced for. It penalises five things. The heaviest are how far
your row sits from that target depth, and off-axis viewing angle, which is how far sideways
you sit divided by how far you are from the screen, so the same sideways offset counts for
more the nearer you sit. Then, at a quarter of the weight each: proximity to the screen and
proximity to any wall, which ST 202's own measurement area gives it, and a run of seats
broken by a console. Every part of it is adjustable.
